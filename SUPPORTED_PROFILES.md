| EEP | Description | Auto detection¹ | Devices | 
|----|----|----|----|
...
|----|----|----|----|
| A5-07-01 | Occupancy sensor | No | EOSCA-W-EO | 
...
| A5-08-02 | Light, Temperature and Occupancy sensor Range 0lx to 1020lx, 0°C to 51°C  | No | Telefunken (MSR Solutions) motion detector bm1 |
...
|----|----|----|----|
| F6-02-02 | Rocker switch with two rocker | Yes | PTM200, PHEA Easyclick, Nodon Wall Switch, Nodon Soft Remote, Nodon Floor Switch |
